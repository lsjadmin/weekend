...
class AliController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->notify_url = env('ALIPAY_NOTIFY_URL');  //回调地址
        $this->return_url = env('ALIPAY_RETURN_URL');
        $this->rsaPrivateKeyFilePath = storage_path('app/keys/private.pem');    //应用私钥
        $this->aliPubKey = storage_path('app/keys/alipay/public.pem'); //支付宝公钥
    }
...
//         dd($order_number);
        ...
        $bizcont = [
            ...
            'total_amount'      => $order_info['price'] / 100,
    ...
    public function notify()
    {
        ...
        // echo 'success';
        // $p=file_get_contents('logs/alipay_notify.log');
        // // //TODO 验签 更新订单状态
        // $data=json_decode($p,true);
        //验证签名
        //dd($data);
        // $sign=base64_decode($data['sign']);
        // $ka=openssl_pkey_get_public($this->aliPubKey); //获取公钥(storage/app/keys/public.pem)
        // $rs=openssl_verify($data,$sign,$ka);
        // dd($rs);
        //判断是否支付成功
